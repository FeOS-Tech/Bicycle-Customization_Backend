            ...
            <div class="details-section">
              ...
              <table class="detail-table" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td class="detail-value">${userDetails.name || 'N/A'}</td>
                </tr>
                <tr>
                  <td class="detail-label">Email</td>
                  <td class="detail-value">${userDetails.email || 'N/A'}</td>
                </tr>
                <tr>
                  <td class="detail-label">Phone</td>
                  <td class="detail-value">${userDetails.phone || 'N/A'}</td>
                </tr>
                <tr>
                  <td class="detail-label">Address</td>
                  <td class="detail-value">${userDetails.address || 'N/A'}</td>
                </tr>
              </table>
            </div>
          </td>
          ...
          <td>
            <div class="details-section">
              ...
              <table class="detail-table" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="detail-label">Name on Cycle</td>
                    ...
                    <div class="col-section">
                      ...
                      <table class="col-detail-table" cellpadding="0" cellspacing="0">
                        ...
                        `<tr>
                          ...
                          <td class="col-detail-value">${formatCmyk(customization.stickerColors.baseCmyk)}</td>
                        </tr>`:''
                      }
                      ${
                        ...
                        `<tr>
                          ...
                          <td class="col-detail-value">${formatCmyk(customization.stickerColors.paintCmyk)}</td>
                        </tr>`:''
                      }
                      ${
                        ...
                        `<tr>
                          ...
                          <td class="col-detail-value">${formatCmyk(customization.stickerColors.decalCmyk)}</td>
                        </tr>`:''
                      }
                      ${
                        ...
                        `<tr>
                          ...
                          <td class="col-detail-value">${formatCmyk(customization.stickerColors.primaryCmyk)}</td>
                        </tr>`:''
                      }
                      ${
                        ...
                        `<tr>
                          ...
                          <td class="col-detail-value">${formatCmyk(customization.stickerColors.secondaryCmyk)}</td>
                        </tr>`:''
                      }
                      </table>
                    </div>
        ...
        <tr>
          <td>
            <div class="footer">
              ...
              <div class="thank-you">
                Admin Panel: https://admin.trackandtrail.in
              </div>
            </div>
          </td>
        </tr>
...
module.exports = ownerOrderNotification;